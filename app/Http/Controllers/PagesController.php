...
class PagesController extends Controller
{
    public function getindex()
    {
        ...
        return view('news.pages.home',['cates'=>$cates,'videos'=>$videos, 'catess'=>$catess]);
    }
    ...
    //     return view('news.partials.sidebar',['cates'=>$cates,'videos'=>$videos]);
    // }
    ...
    public function getCategory($slug)
    {
        ...
        // } else 
        {
            $list = Post::where('category_id',$cate->id)->where('status',1)->orderBy('created_at','des')->paginate(4);
