...
<aside id="sidebar" class="four column pull-right">
	<ul class="no-bullet">
    		...
    		<div id="popular-tab" class="shine">
    			<ul>
    				...
    				<li class="shine-o">
    					...
    					<div class="post-date">{{date('G:i d-m-Y', strtotime($post->updated_at)) }}</div>
    				</li>
    				@endforeach
    			</ul>
    		</div>	
		...
		<li class="widget widget_ads_big clearfix">
			...
			<div class="clearfix">
				<a href=""><img alt="" src="https://nguyencongpc.vn/media/banner/09_May78e25aeb83ed9abf69fc06e4a94e510a.jpg"></a>
			</div>
		</li>
		...
		<li class="widget widget_video clearfix">
			...
			<div class="flex-video widescreen">
				<?php 
					...
					$post_video = $posts->sortByDesc('created_at')->where('post_type','video')->take(1); ?>
